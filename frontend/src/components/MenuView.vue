  ...
  data() {
    return {
      ...
      configurations: [
        ...
        {
          index: 2,
          name: "Family day: Combine your museums day with your kids urge to play at the playground",
          activeSliders: ["Playgrounds", "Museums"],
          values: [1000, 1000],
          isMin: [false, false],
        },
        {
          index: 3,
          name: "Bath day: Sports facilities and baths next to each other to let you relax after doing sports",
          activeSliders: ["Playgrounds", "Museums"],
          values: [1000, 1000],
          isMin: [false, false],
        },
